function FlightFactor(alternativeHost) {
    if (typeof alternativeHost == 'undefined') {
        alternativeHost = '';
    }
    ...
    if (document.location.host != '') { // we are in browser, use document.location
        var host = document.location.host;
        if (alternativeHost != '') {
            host = alternativeHost
        }
        //console.log('Socket: ws://' + host);
        ...
        this.Socket = new WebSocket('ws://' + host, 'json');
